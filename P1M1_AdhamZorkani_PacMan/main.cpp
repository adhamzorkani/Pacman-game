...
int main(int argc, char *argv[])
{
    ...
    view.setScene(&scene);
    QFile file("C:/Users/HP/CS2/PacMan/P1M1_AdhamZorkani_PacMan/board.txt");//start of drawing board
   ...
   for (int j=0;j<12;j++)
   {
     ...
     QPixmap bricksImage("C:/Users/HP/CS2/PacMan/P1M1_AdhamZorkani_PacMan/border1.png");
     bricksImage = bricksImage.scaledToWidth(50);
     bricksImage = bricksImage.scaledToHeight(50);
     QPixmap floorImage("C:/Users/HP/CS2/PacMan/P1M1_AdhamZorkani_PacMan/grass1.png");
   ...
   pinky = new Ghost("Pinky","C:/Users/HP/CS2/PacMan/P1M1_AdhamZorkani_PacMan/pinky.png", 5,5,boardData);
   scene.addItem(pinky);
   Ghost * inky;
   inky = new Ghost("Inky","C:/Users/HP/CS2/PacMan/P1M1_AdhamZorkani_PacMan/inky.png", 6,5,boardData);
   scene.addItem(inky);
   Ghost * clyde;
   clyde = new Ghost("Clyde","C:/Users/HP/CS2/PacMan/P1M1_AdhamZorkani_PacMan/clyde.png" ,6,6,boardData);
   scene.addItem(clyde);// end of adding ghost

   Player p(9,5,boardData ,Score, Lives, mode);//drawing pacman
   scene.addItem(&p);
